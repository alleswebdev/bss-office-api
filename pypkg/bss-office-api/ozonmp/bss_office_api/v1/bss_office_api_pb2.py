...
_LISTOFFICESV1REQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=_b('\372B\0062\004\020d \000'), json_name='limit', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
...
UpdateOfficeV1Request = _reflection.GeneratedProtocolMessageType('UpdateOfficeV1Request', (_message.Message,), dict(
...
UpdateOfficeV1Response = _reflection.GeneratedProtocolMessageType('UpdateOfficeV1Response', (_message.Message,), dict(
...
_BSSOFFICEAPISERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\002&\022$/api/v1/office/list/{limit}/{offset}'),
  ),
  _descriptor.MethodDescriptor(
    name='UpdateOfficeV1',
    ...
    serialized_options=_b('\202\323\344\223\002\023\032\016/api/v1/office:\001*'),
  ),
])
