...
// Source: github.com/ozonmp/bss-office-api/internal/app/repo (interfaces: EventRepo)
...
func (m *MockEventRepo) Add(arg0 []model.OfficeEvent) error {
	m.ctrl.T.Helper()
...
func (m *MockEventRepo) Lock(arg0 uint64) ([]model.OfficeEvent, error) {
	m.ctrl.T.Helper()
